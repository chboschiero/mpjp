...
public class AboutStringBuilder {
	public static void main(String[] args) {
		...
		System.out.println("appending: " + sb3.append(' ').append("world")); // posso fare un "trenino" di chiamata
																				// (perché append è un metodo che mi
																				// ritorna un riferimento a se stesso)
		...
		System.out.println("inserting \"lo c\" at 3: " + sb3.insert(3, "lo c"));// permette di inserire una stringa a
